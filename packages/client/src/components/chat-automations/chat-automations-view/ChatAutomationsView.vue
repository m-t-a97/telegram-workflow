<template>
  <div class="chat-automations-view-container">
    <div
      v-if="isFetchingChatAutomations"
    ...
    <div v-if="!isFetchingChatAutomations">
      <ChatAutomationsViewActionButtons
        ...
        @creating-new-automation="onCreatingNewAutomation()"
        @deleting-chat-automations="onDeletingChatAutomations()"
        @chat-automations-deleted="onDeletedChatAutomations()"
      />

      <ChatAutomationsViewList
        :chatAutomations="chatAutomations"
        :chatAutomationsToggleStateMap="chatAutomationsToggleStateMap"
        :isChatAutomationsBeingDeleted="isChatAutomationsBeingDeleted"
        @list-item-toggled="onListItemToggled($event)"
      />
    </div>
  </div>
</template>
